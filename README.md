...
- **[React Toastify](https://github.com/fkhadra/react-toastify)** - Notificaciones del sistema
...
- **[Heroicons](https://heroicons.com/)** - Iconografía moderna de Tailwind
- **[Phosphor Icons](https://phosphoricons.com/)** - Biblioteca de iconos flexible
...
│   ├── editor/                   # Editor de salas y mapas
│   ├── play/                     # Experiencia de usuario en salas
...
│   ├── Navbar/                   # Navegación
│   └── VideoChat/                # Sistema de videochat
│       ├── VideoBar.tsx          # Barra de video principal
│       ├── ScreenShareModal.tsx  # Modal de pantalla compartida
